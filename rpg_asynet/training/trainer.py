...
class FBSparseVGGModel(AbstractTrainer):
    ...
    def train(self):
        ...
        print('\nentramos FBSparseVGGModel bien\n')
        iteracionActual=0
        while iteracionActual < 1000:#True:
            iteracionActual += 1
...
class DenseVGGModel(AbstractTrainer):
    ...
    def train(self):
        """Main training and validation loop"""
        print('\nentramos DenseVGGModel\n')
        iteracionActual=0
        while iteracionActual < 100:
            iteracionActual += 1
            print('\nestamos en la it',iteracionActual)
...
class SparseObjectDetModel(AbstractTrainer):
    ...
    def train(self):
        ...
        print('\nentramos SparseObjectDetModel 500\n')
        iteracionActual=0
        while iteracionActual < 500:#True:
            iteracionActual += 1
            print('\nestamos en la it',iteracionActual)
            self.trainEpoch()
...
class DenseObjectDetModel(AbstractTrainer):
    ...
    def train(self):
        ...
        print('\nentramos DenseObjectDetModel\n')
        iteracionActual=0
        while iteracionActual < 100:#True:
            iteracionActual += 1
            print('\nestamos en la it',iteracionActual)
            self.trainEpoch()
            if (self.epoch_step % validation_step) == (validation_step - 1):
