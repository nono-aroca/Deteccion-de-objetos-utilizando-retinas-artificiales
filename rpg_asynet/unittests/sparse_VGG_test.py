...
class TestSparseVGG(unittest.TestCase):
    def test_sparse_VGG_artificial_input(self):
        ...
        for i_test in tqdm.tqdm(range(1)):
            ...
            pth = '/home/aaroca/catkin_ws/src/rpg_asynet/log/20210416-174340/checkpoints/model_step_75.pth' #'PATH_TO_MODEL'
    ...
    def test_sparse_VGG_event_input(self):
        ...
        # ---- Create Input ----
        dataset_path = '/home/aaroca/catkin_ws/src/rpg_asynet/data/N-Caltech101' #'PATH_TO_DATA/N-Caltech101'
        height = 180
        width = 240
