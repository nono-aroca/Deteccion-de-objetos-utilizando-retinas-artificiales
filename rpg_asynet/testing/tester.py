...
#                                           mode='testing',
#                                           event_representation=self.settings.event_representation)
#        self.nr_val_epochs = int(val_dataset.nr_samples / 1) + 1
#
...
#        self.val_loader = self.dataset_loader(val_dataset, batch_size=1,
#                                              device=self.settings.gpu_device,
#                                              num_workers=self.settings.num_cpu_workers, pin_memory=False)
#
#    @staticmethod
...
#            file_path = os.path.join(self.settings.vis_dir, 'image_' + str(i_batch) + '.png')
